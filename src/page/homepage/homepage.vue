<template>
  <div>
    ...
    <div ref="homePage">
      <!--轮播-->
      <div >
        <mt-swipe :auto="4000" class="luobo">
...
//        hrefArr : [
//          {
//            href : 'https://wap.epet.com/group/v226/main.html?pettype=cat&pet_type=cat&fw=0',
//            src : echongtuan
//          },
//          {
//            href : 'http://wap.epet.com/v2/brandsale.html?pet_type=cat&fw=0',
//            src : pinpaitemai
//          }
//          ,
//          {
//            href : 'http://wap.epetht.com/guide.html?pet_type=dog&fw=0&pet_type=cat',
//            src : echongguoji
//          },
//          {
//            href : 'https://sale.epet.com/m/mould/fashion/main.html?pet_type=cat&pet_type=cat&fw=0',
//            src : chaopinyushou
//          },
//          {
//            href : 'http://wap.epet.com/activity/cleargoods.html?pet_type=cat&fw=0',
//            src : qingchangtejia
//          },
//          {
//            href : 'https://wap.epet.com/main.html?menu_param=5&is_single=1&pet_type=cat&fw=0',
//            src : xinmiaoketang
//          },
//          {
//            href : 'http://wap.epet.com/trial/?pet_type=cat&fw=0',
//            src : tiyanguan
//          },
//          {
//            href : 'https://wap.epet.com/main.html?menu_param=148&is_single=1&pet_type=cat&fw=0',
//            src : chaopinshipin
//          },
//          {
//            href : 'https://wap.epet.com/article/video/List.html?do=KnowledgeVideo&pet_type=cat&fw=0',
//            src : mengchongshuo
//          },
//          {
//            href : 'https://wap.epet.com/article/video/List.html?do=AdorableVideo&pet_type=cat&fw=0',
//            src : xiaojuchang
//          }
//        ]
      }
